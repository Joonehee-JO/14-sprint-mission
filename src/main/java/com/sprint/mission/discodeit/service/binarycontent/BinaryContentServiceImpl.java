...
public class BinaryContentServiceImpl implements BinaryContentService {
    ...
    public List<BinaryContent> storeFiles(List<MultipartFile> multipartFiles) throws IOException {
     ...
     */
    public BinaryContent storeFile(MultipartFile multipartFile) throws IOException {
        if (multipartFile.isEmpty()) {
